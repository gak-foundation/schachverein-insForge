  ...
  <div className="p-8 rounded-xl border mb-12" style={{ backgroundColor: bg }}>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="bg-white p-6 rounded-lg shadow-sm border border-border">
        ...
        <h3 className="font-bold text-foreground">Vereinsmeisterschaft</h3>
        <p className="text-sm text-muted-foreground mb-4">Runde 5 von 9 • 18:00 Uhr</p>
      ...
      <div className="space-y-4">
        <h4 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground">Interaktion</h4>
      ...
      <div className="max-w-5xl mx-auto">
        <header className="text-center mb-16">
          <h1 className="text-4xl font-extrabold text-foreground mb-4 tracking-tight">
            Design-Vorschau: <span className="text-muted-foreground">Schachverein</span>
          </h1>
          <p className="text-lg text-muted-foreground">
            Farbpaletten fur ein serioses, zuverlassiges und vertrauenswurdiges Auftreten.
          </p>
        </header>
        ...
        <ColorPreview 
          ...
          description="Der Standard fur Autoritat und Vertrauen. Wirkt professionell, stabil und modern."
        ...
        <ColorPreview 
          ...
          description="Klassisch, naturverbunden und bestandig. Erinnert an traditionelle Clubzimmer."
        ...
        <footer className="text-center text-muted-foreground text-sm mt-12">
          Alle Farben sind in OKLCH definiert fur maximale Farbtreue und Kontrast.
        </footer>
      </div>
    </div>
  );
