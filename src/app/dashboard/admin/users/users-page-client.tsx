...
const ROLE_STYLES: Record<string, string> = {
  ...
  spielleiter: "bg-green-100 text-green-700 ring-green-600/20",
...
function UsersTable({ users: userList }: { users: User[] }) {
  return (
...
export function UsersPageClient({ users, search, role }: UsersPageClientProps) {
  return (
