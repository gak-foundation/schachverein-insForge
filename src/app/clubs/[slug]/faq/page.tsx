          ...
          <section>
            ...
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="anmeldung">
                ...
                <AccordionContent>
                  <p className="text-gray-600 leading-relaxed">
                    Besuchen Sie <Link href="/" className="text-primary hover:underline">schach.studio</Link> und klicken Sie auf „Kostenlos testen“. Nach der Registrierung erhalten Sie umgehend Zugang.
                  </p>
                </AccordionContent>
              </AccordionItem>
            </Accordion>
