      ...
      new QueryClient({
        defaultOptions: {
          queries: {
            ...
            staleTime: 10 * 60 * 1000, // 10 Minuten (global, reduziert API-Last)
            // 10 Minuten Cache Time
            gcTime: 30 * 60 * 1000, // 30 Minuten (längerer Cache für Offline-Nutzung)
            // Retry bei Fehlern
            retry: 1, // Weniger Retries bei Fehlern (schont Rate-Limits)
